SELECT
  ...
  JOIN {{ ref('stage_salesorderdetail')}} stage_salesorderdetail
    ...
    AND IFNULL(dim_employee.dss_start_date, GETDATE()-10000) <= stage_salesorderheader.orderdate
    AND IFNULL(dim_employee.dss_end_date, GETDATE()+10000) >= stage_salesorderheader.orderdate
